  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" autocomplete="on" label-position="left">
      ...
      <div style="position:relative">
        ...
        <el-button @click="go(loginGoogleURI)">
          Google
        </el-button>
        <el-button @click="go(loginBitbucketURI)">
          Bitbucket
        </el-button>
    ...
    <div id="login_container_weixin" style="color: white">
      微信二维码
    </div>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    loginBitbucketURI() {
      return config.serverURI + '/auth/bitbucket'
    },
    loginWeixinURI() {
      return config.serverURI + '/auth/weixin'
    }
  },
  watch: {
    $route: {
  ...
  methods: {
    ...
    weixin() {
      ...
      new WxLogin({
        self_redirect: true,
        id: 'login_container_weixin',
        appid: 'wx4dbdf69d200edc97',
        scope: 'snsapi_login',
